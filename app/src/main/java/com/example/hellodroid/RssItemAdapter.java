...
public class RssItemAdapter extends RecyclerView.Adapter {
    private List<RssItemViewModel> models = new ArrayList<>();
    private RecyclerItemViewClickListener mListener;
     ...
     */
    public RssItemAdapter(final List<RssItemViewModel> viewModels, RecyclerItemViewClickListener listener) {
        if (viewModels != null) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, final int viewType) {
        ...
        return new RssItemViewHolder(view, mListener);
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ((RssItemViewHolder) holder).bindData(models.get(position));
    }
